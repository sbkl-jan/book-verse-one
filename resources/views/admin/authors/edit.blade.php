...
<main class="flex-1 p-8 bg-gray-900 min-h-screen">
    <div class="max-w-2xl mx-auto">
        <h2 class="text-4xl font-bold mb-8 text-gray-100" style="font-family: 'Newsreader', serif;">Edit Author</h2>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="bio" id="bio" rows="4" 
                                  class="mt-1 block w-full rounded-md border-gray-600 bg-gray-700 text-gray-100 shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('bio', $author->bio) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        @if ($author->photo)
                            <img src="{{ asset('storage/' . $author->photo) }}" alt="{{ $author->name }}" class="w-20 h-20 rounded-full object-cover my-2">
                        @endif
